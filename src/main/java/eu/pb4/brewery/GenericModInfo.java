...
public class GenericModInfo {
    ...
    private static Component[] iconBook = new Component[0];
    ...
    public static void build(ModContainer container) {
        {
            ...
            var iconBook = new ArrayList<MutableComponent>();
            try {
                {
            ...
            GenericModInfo.iconBook = iconBook.toArray(new Component[0]);
        }

        {
            ...
            try {
                ...
                about.add(Component.translatable("text.brewery.about.version").setStyle(Style.EMPTY.withColor(0xf7e1a7))
                ...
                about.add(Component.literal("")
                        .append(Component.translatable("text.brewery.about.contributors")
    ...
    public static Component[] getIconBook() {
        return iconBook;
    }
