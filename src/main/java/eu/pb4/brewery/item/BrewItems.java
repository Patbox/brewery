...
public class BrewItems {
    ...
    public static final PolymerBlockItem BARREL_SPIGOT = register("barrel_spigot", new PolymerBlockItem(
            BrewBlocks.BARREL_SPIGOT, new Item.Settings().maxCount(16).group(ITEM_GROUP), Items.TRIPWIRE_HOOK
    ));
    ...
    public static final BlockTickerItem DEBUG_BLOCK_TICKER = register("debug/block_ticker", new BlockTickerItem(new Item.Settings().group(ITEM_GROUP)));
